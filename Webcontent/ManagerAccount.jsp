            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__inner text-center">
                        <h2 class="breadcrumb-title">Manager Account</h2>
                        <nav class="breadcrumb-content">
                            <a class="breadcrumb_item" href="home">Home</a>
                            <span class="brd-separator">/</span>
                            <span class="breadcrumb_item active">Manager Account</span>
                        </nav>
                    </div>
                </div>
            </div>
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<c:forEach items="${accountPage}" var="o">
					<tr>
						<td>${o.id}</td>
						<td>${o.user}</td>
						<td>
...
<div id="deleteEmployeeModal${o.id}" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="deleteAccount?pid=${o.id}" method="post">
